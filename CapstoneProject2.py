...
# I stuggled to create a list to add 3 enemy objects. I searched everywhere online to do it but most tutorials require you to use:
# classes, lists, defining a function,etc
# These are some of the links I used: https://www.youtube.com/watch?v=ML2w92TIzoA&list=WL&index=2
...
# add the prize image and where the image is found
...
# Get the width and height of the prize
...
# Make the enemy start off at a random x and y position.

enemyXPosition =  random.randint(0, screen_width - enemy_width)
enemyYPosition =  random.randint(0, screen_height - enemy_height)

enemyXPosition2 =  random.randint(0, screen_width - enemy_width)
enemyYPosition2 =  random.randint(0, screen_height - enemy_height)

enemyXPosition3 =  random.randint(0, screen_width - enemy_width)
enemyYPosition3 =  random.randint(0, screen_height - enemy_height)

# Prize x and y postion
prizeXPosition = 800
prizeYPosition = 340
...
while 1: # This is a looping structure that will loop the indented code until you tell it to stop(in the event where you exit the program by quitting).
    ...
    # If the player collides with the prize the player wins the game:
